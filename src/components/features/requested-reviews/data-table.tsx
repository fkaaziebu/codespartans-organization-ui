  ...
  return (
    <>
      <div className="flex w-full rounded-t-lg border border-b-0 border-gray-100 px-6 py-3">
        <Input className="w-[20%]" placeholder="Search review by course name" />
      </div>
              ...
              <div className="z-30 flex w-full flex-col items-center gap-4">
                ...
                <div className="flex w-[40%] flex-col items-center gap-1">
                  <h3 className="text-base font-semibold text-gray-900">
                    No Requested Reviews yet
                  </h3>
                  <p className="text-center text-sm text-wrap text-[#535862]">
                    Instructors will request reviews for their courses. Once
                    they do, you can assign them to to administrators
                  </p>
                </div>
              </div>
            </div>
