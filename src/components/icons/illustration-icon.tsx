export const IllustrationIcon = () => {
  return (
    ...
    >
      ...
      <g filter="url(#filter0_ddd_20846_124877)">
        <path
        ...
        <ellipse
          ...
          rx="25.6"
          ry="25.6"
          fill="url(#paint0_linear_20846_124877)"
        />
        <circle
          cx="78.5996"
          cy={48}
          r={32}
          fill="url(#paint1_linear_20846_124877)"
        />
        <ellipse
          cx="110.6"
          cy="57.5999"
          rx="22.4"
          ry="22.4"
          fill="url(#paint2_linear_20846_124877)"
        />
      </g>
      <circle cx={22} cy={19} r={5} fill="#FAFAFA" />
      <circle cx={19} cy={109} r={7} fill="#FAFAFA" />
      <circle cx={146} cy={35} r={7} fill="#FAFAFA" />
      ...
      <defs>
        ...
        >
          ...
          <feMorphology
            ...
            operator="erode"
            in="SourceAlpha"
            result="effect1_dropShadow_20846_124877"
          />
          <feOffset dy={3} />
          <feGaussianBlur stdDeviation="1.5" />
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.0392157 0 0 0 0 0.0509804 0 0 0 0 0.0705882 0 0 0 0.04 0"
          />
          <feBlend
            mode="normal"
          ...
          <feMorphology
            ...
            operator="erode"
            in="SourceAlpha"
            result="effect2_dropShadow_20846_124877"
          />
          <feOffset dy={8} />
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_20846_124877"
            result="effect2_dropShadow_20846_124877"
          />
          <feColorMatrix
            in="SourceAlpha"
          ...
          <feMorphology
            ...
            operator="erode"
            in="SourceAlpha"
            result="effect3_dropShadow_20846_124877"
          />
          <feOffset dy={20} />
          ...
          <feBlend
            mode="normal"
            in2="effect2_dropShadow_20846_124877"
            result="effect3_dropShadow_20846_124877"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect3_dropShadow_20846_124877"
            result="shape"
          />
        </filter>
        <clipPath
          id="bgblur_0_20846_124877_clip_path"
          transform="translate(-45 -54)"
        >
          <rect x={53} y={62} width={48} height={48} rx={24} />
        </clipPath>
        <linearGradient
          id="paint0_linear_20846_124877"
          x1="26.9429"
          y1="37.4858"
          x2="72.2"
          y2={80}
